...
if __name__=="__main__":
    ...
    parser.add_argument('--input', type=str, default="./demo/Dance.mp4", help='test imgs folder or video or camera')
    parser.add_argument('--output', type=str, default="./demo/output.mp4", help='folder to save result imgs, can not use input folder')
